...
data Types = Void
           ...
           | TemplateType TemplateClass
             -- ^ the template class itself. myclass<T> in template<typename T> myclass;
           | TemplateParam TemplateParamType
             -- ^ parameter class. T in template<typename T> myclass;
           | TemplateParamPointer TemplateParamType
